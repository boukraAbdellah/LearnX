...
export function BellFilledIcon({ size = 24, className = "" }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      className={className}
    >
      <path d="M12 2a6 6 0 0 0-6 6c0 6.16-2.4 7.67-2.83 7.91A1 1 0 0 0 4 17h16a1 1 0 0 0 .83-1.09C20.4 15.67 18 14.16 18 8a6 6 0 0 0-6-6Zm0 20a2.5 2.5 0 0 0 2.45-2h-4.9A2.5 2.5 0 0 0 12 22Z" />
    </svg>
  );
}
  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M10.5 3a7.5 7.5 0 1 0 4.67 13.37l4.73 4.73a1 1 0 0 0 1.41-1.41l-4.73-4.73A7.5 7.5 0 0 0 10.5 3Zm-5.5 7.5a5.5 5.5 0 1 1 11 0 5.5 5.5 0 0 1-11 0Z"
      />
    </svg>
  );
}

export function PlayCircleIcon({ size = 24, className = "" }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function PlayCircleFilledIcon({ size = 24, className = "" }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function FileTextFilledIcon({ size = 24, className = "" }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function BookmarkFilledIcon({ size = 24, className = "" }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M17 3H7c-1.1 0-2 .9-2 2v16l7-4.5 7 4.5V5c0-1.1-.9-2-2-2Z" />
    </svg>
  );
}
...
export function BarChartFilledIcon({ size = 24, className = "" }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      className={className}
    >
      <path d="M4 15h4v6H4v-6Zm6-6h4v12h-4V9Zm6-6h4v18h-4V3Z" />
    </svg>
  );
}
...
export function ClockFilledIcon({ size = 24, className = "" }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      className={className}
    >
      <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2Zm1 11h-1a1 1 0 0 1-1-1V6a1 1 0 1 1 2 0v4.59l2.71 1.62a1 1 0 1 1-1.02 1.72L13 13Z" />
    </svg>
  );
}
...
export function UserFilledIcon({ size = 24, className = "" }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function InProgressIcon({ size = 24, className = "" }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      className={className}
    >
      <circle cx="12" cy="12" r="10" strokeDasharray="32 16" />
    </svg>
  );
}
...
export function AccessibleIcon({ size = 24, className = "" }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function DocumentTextIcon({ size = 24, className = "" }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
